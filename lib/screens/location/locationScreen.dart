...
class _LocationScreenState extends State<LocationScreen> {
  ...
  StreamSubscription<location.LocationData>? _locationSubscription;
  String _locationName = "Unknown Location";
  final String _apiKey = "AIzaSyBQqPT4G8aMXgtpcYk1gM3OPO1xh1UkJCs";
  final places = GoogleMapsPlaces(apiKey: "AIzaSyBQqPT4G8aMXgtpcYk1gM3OPO1xh1UkJCs");
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      setState(() {
        ...
        _updateMarkers();
        _moveCameraToCurrentLocation();
        _getLocationName(_currentLocation!);
        
        // Update LocationController with coordinates
  ...
  Future<void> _handleSearch() async {
    ...
    if (p != null) {
      ...
      setState(() {
        ...
        // Update LocationController with coordinates
        locationController.updateCoordinates(lat, lng);
      });
    }
  }
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () async {
                        if (_currentLocation != null) {
                          ...
                          // Update both address and coordinates in LocationController
                          locationController.updateLocationFromMap(
                            newAddress,
                            _currentLocation!.latitude,
                            _currentLocation!.longitude,
                          );
