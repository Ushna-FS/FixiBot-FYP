          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: "Search services by mechanic, vehicle, or issue...", // ✅ REMOVED status from hint
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ UPDATED: Show buttons for all services (no status restrictions)
            Row(
              children: [
                // Update button for all services
                Expanded(
