...
class _HomePageState extends State<HomeScreen> {
  ...
  final List<List<String>> issuesList = [
    ["Flat Tire","Battery Failure", "Engine Overheat", "Break failure",],
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: const Text("Self Help")),
//       body: FutureBuilder<List<BreakdownModel>>(
//         future: futureBreakdowns,
//         builder: (context, snapshot) {
//           if (snapshot.connectionState == ConnectionState.waiting) {
...
//                   Get.to(() => SelfHelpSolutions(issueData: {
//                         "Name": issue.name,
//                         "In Cars": issue.categories["Car"],
//                         "In Bikes": issue.categories["Bike"],
//                         "In Trucks/Heavy Vehicles": issue.categories["Truck"],
//                       }));
//                 },
//               );
//             },
