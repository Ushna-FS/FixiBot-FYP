                ...
                child: Column(
                  ...
                  children: [
                    ...
                    PinCodeTextField(
                      ...
                      onChanged: (value) {
                        // Update controller text as user types
                        controller.otpController.text = value;
                      },
                      onCompleted: (verificationCode) {
                        // 🔥 FIX: Set OTP but don't auto-verify
                        controller.otpController.text = verificationCode;
                      },
                    ),
          ...
          style: AppFonts.montserratGreyText14,
                    ...
                    Obx(() => CustomButton(
                      ...
                      onPressed: controller.isLoading.value 
                          ? null 
                          : () async {
                              // 🔥 FIX: Check if OTP is already entered
                              ...
                              await controller.verifyEmailWithOtp(email);
                            },
                    )),
                    
                    // 🔥 Add a note about OTP validity
